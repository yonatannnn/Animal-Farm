...
import 'package:micro/widgets/singleCowToDelete.dart';

class DeleteCowListScreen extends StatelessWidget {
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              return SingleCowToDetle(cow: cows[index], index: index + 1);
            },
          );
        }
      },
